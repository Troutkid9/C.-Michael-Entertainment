...
var StateManager = {
  ...
  loadGameOptions: function () {
    ...
    if (this.db !== null && typeof this.db !== "undefined") {
      this.db.get(
        "gameOptions",
        this.onLoadGameOptions.bind(this),
        this.onFailure.bind(this)
      );
    } else;
  ...
  onLoadGameOptions: function (gameOptions) {
    if (gameOptions !== null) {
      if (CM.DEBUG) Mojo.Log.info(Object.toJSON(gameOptions));
  ...
  onLoadScores: function (scores) {
    if (scores !== null) {
      if (CM.DEBUG) Mojo.Log.info(Object.toJSON(scores));
